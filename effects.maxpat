...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.5, 12.5, 88.0, 20.0 ],
					"style" : "",
					"text" : "sensor effects"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.5, 35.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 516.0, 487.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 487.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 12.5, 87.0, 20.0 ],
					"style" : "",
					"text" : "One Channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 35.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.5, 86.0, 174.0, 20.0 ],
					"style" : "",
					"text" : "feedback delay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.5, 202.0, 91.0, 20.0 ],
					"style" : "",
					"text" : "delay time (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 487.0, 226.5, 33.0, 33.0 ],
					"size" : 15000.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 487.0, 271.5, 59.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.25, 113.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 85"
				}
...
,
					"patching_rect" : [ 516.0, 390.0, 54.0, 22.0 ],
...
,
					"patching_rect" : [ 516.0, 120.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 516.0, 365.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 168.0, 49.0, 20.0 ],
					"style" : "",
					"text" : "wet/dry"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 409.5, 190.0, 40.0, 40.0 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 647.0, 156.0, 59.0, 20.0 ],
					"style" : "",
					"text" : "feedback"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 656.5, 187.0, 40.0, 40.0 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 646.0, 292.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 516.0, 327.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "tapout~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 516.0, 156.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "tapin~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 124.0, 174.0, 20.0 ],
					"style" : "",
					"text" : "filter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 108.0, 155.0, 124.0, 19.0 ],
					"size" : 6000.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 187.0, 79.0, 23.0 ],
					"style" : "",
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 198.0, 214.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.0, 215.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "line~ 200"
				}
...
,
					"patching_rect" : [ 18.0, 244.0, 199.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
